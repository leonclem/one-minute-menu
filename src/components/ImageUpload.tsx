...
export default function ImageUpload({ 
  ...
  // Detect camera availability on client after mount to avoid SSR hydration mismatch
  const [hasCamera, setHasCamera] = useState(false)
  useEffect(() => {
    try {
      const available = typeof navigator !== 'undefined' &&
        !!(navigator.mediaDevices && (navigator.mediaDevices as any).getUserMedia)
              ...
              {hasCamera && (
                <div className="relative mb-4">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white/80 backdrop-blur-[1px] text-gray-700">or</span>
                  </div>
                </div>
              )}
              ...
              <div
                className={`border-2 border-dashed rounded-lg p-8 transition-colors ${
                  dragActive
                    ...
                    : 'border-gray-300 hover:border-gray-400 bg-white/95'
                }`}
