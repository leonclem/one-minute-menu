/**
 * Shared V2 template options for the menu template page.
...
/** V2 templates shown on the menu template page. Order: 6 col A3 portrait (default), 4 col portrait, 3 col portrait, 2 col portrait, 1 col tall, 5 col landscape. */
