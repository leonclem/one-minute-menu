...
function parseConfig(templateId: string, c: Record<string, unknown>) {
  ...
  return {
    ...
    showLogoTile: c.showLogoTile === true,
    showCategoryHeaderTiles: c.showCategoryHeaderTiles === true,
    showFlagshipTile: c.showFlagshipTile === true,
  ...
  const fetchLayout = useCallback(async () => {
    ...
    try {
      const params = new URLSearchParams({
        ...
        showLogoTile: config.showLogoTile.toString(),
        showCategoryHeaderTiles: config.showCategoryHeaderTiles.toString(),
        showFlagshipTile: config.showFlagshipTile.toString(),
