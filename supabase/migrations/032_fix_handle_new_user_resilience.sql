-- Migration 032: Restore handle_new_user resilience
-- This fixes the regression from migration 031 which caused signup failures if ghost data exists.
-- It merges the approval system (031) with the robustness features from migration 029.
