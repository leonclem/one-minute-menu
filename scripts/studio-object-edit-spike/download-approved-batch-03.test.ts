...
const resultPath = join(resultDirectory, 'remove-nb2-batch-03.json')
...
const downloadApprovedBatch = process.env.DOWNLOAD_APPROVED_NB2_REMOVE_BATCH_03 === 'true' ? it : it.skip

downloadApprovedBatch('downloads and verifies generated batch 03 artifacts for internal review only', async () => {
