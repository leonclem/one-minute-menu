...
const resultPath = join(resultDirectory, 'remove-nb2-batch-01.json')
...
const downloadApprovedBatch = process.env.DOWNLOAD_APPROVED_NB2_REMOVE_BATCH_01 === 'true' ? it : it.skip

downloadApprovedBatch('downloads and verifies generated artifacts for internal review only', async () => {
