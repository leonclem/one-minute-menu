...
const resultPath = join(resultDirectory, 'move-nb2-batch-01.json')
...
const downloadApprovedBatch = process.env.DOWNLOAD_APPROVED_NB2_MOVE_BATCH_01 === 'true' ? it : it.skip

downloadApprovedBatch('downloads and verifies generated Move/NB2 batch 01 artifacts for internal review only', async () => {
