 ...
 *
 * Internal-only invocation for the user-approved Move/NB2 batch 03. It is
...
const resultPath = join(fixtureDirectory, 'results', 'move-nb2-batch-03.json')
const approvedCaseIds = [
  'move-07-pizza-basil',
  'move-08-roast-beef-knife',
  'move-09-salmon-milk',
] as const
...
const fileNameByCaseId: Record<ApprovedCaseId, string> = {
  'move-07-pizza-basil': '07-pizza-neopolitana.jpg',
  'move-08-roast-beef-knife': '08-Roast-beef-dinner-wide-FS.webp',
  'move-09-salmon-milk': '09-salmon-mash-asparagus.jpg',
}
...
function targetLabel(caseId: ApprovedCaseId): string {
  return {
    'move-07-pizza-basil': 'basil leaves on the pizza',
    'move-08-roast-beef-knife': 'knife at the lower-left of the plate',
    'move-09-salmon-milk': 'glass of milk at the upper-right of the plate',
  }[caseId]
}
...
const runApprovedBatch = process.env.RUN_APPROVED_NB2_MOVE_BATCH_03 === 'true' ? it : it.skip

describe('Move/NB2 batch 03', () => {
